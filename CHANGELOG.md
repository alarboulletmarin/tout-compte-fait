...
- **Une page qui ne défile pas.** L'écran empilait dix-sept blocs dans une colonne de trois mille pixels : on réglait un taux en bas et on remontait voir ce que ça changeait. La réponse est en tête, la figure prend toute la place restante, les réglages sont des pilules au bas du pouce — chacune dit **sa valeur** plutôt que son nom : « 3 comptes », « 2,40 % – 5 % », « 10 ans » —, et ce qui se règle s'ouvre en feuille montante.
