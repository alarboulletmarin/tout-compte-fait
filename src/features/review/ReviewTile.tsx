...
import { useCurrentYm, useMonthFilter, useReviewLines, useReviewQueueIds } from '@/store/selectors'
 ...
 * Sous filtre, la section « À confirmer » du mois reste, elle, et elle compte
 * ce qu'on regarde.
 *
...
export function ReviewTile() {
  ...
  const shown = waiting > 0 && filter.kind === 'all'
