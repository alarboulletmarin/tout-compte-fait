...
**L'étage suivant est nommé, pas promis.** Un **plan** — un support cible, un versement prévu, une hypothèse, un horizon — comparerait chaque mois le prévu au confirmé, montrerait l'adhérence, l'écart cumulé, et la projection **recalée depuis le capital réel** plutôt que depuis le plan théorique. C'est ce qui ferait d'une calculatrice une raison d'ouvrir l'app, et c'est un chantier à part (§2) : il ajoute une entité au document, donc des migrations et une lecture de plus sur chaque écran d'épargne. La seule contrainte qu'il pose dès maintenant est qu'un scénario du simulateur doit pouvoir être promu en plan sans re-saisie — ce que quatre nombres et une nature de taux permettent par construction. **Aucun champ n'est posé d'avance**, et l'écran ne promet aucune date : il dit seulement qu'il ne lit rien pour l'instant.
